...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,586 | 🐛 112 | 🌐 JavaScript | 📅 2026-09-15 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,518 | 🐛 102 | 🌐 Java | 📅 2026-09-15 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,572 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-04 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,804 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
* [ipfs-companion](https://github.com/ipfs/ipfs-companion) ⭐ 2,160 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-01 - Browser extension that simplifies access to IPFS resources.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 951 | 🐛 105 | 🌐 TypeScript | 📅 2026-09-16 - Decentralized Solidity contract source code verification service
