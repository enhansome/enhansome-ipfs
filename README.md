...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,557 | 🐛 110 | 🌐 JavaScript | 📅 2026-08-10 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,445 | 🐛 102 | 🌐 Java | 📅 2026-08-11 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 873 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-11 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,795 | 🐛 24 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
* [ipfs-companion](https://github.com/ipfs/ipfs-companion) ⭐ 2,158 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-06 - Browser extension that simplifies access to IPFS resources.
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,096 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-12 - Checks which public gateways are online or not.
* [ipfs-deploy](https://github.com/agentofuser/ipfs-deploy) ⭐ 1,169 | 🐛 31 | 🌐 JavaScript | 📅 2025-05-10 - Zero-config CLI to deploy static websites: cd my-static-website && npx @agentofuser/ipfs-deploy
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 944 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-11 - Decentralized Solidity contract source code verification service
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,096 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-12
