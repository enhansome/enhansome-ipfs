...
To submit your project, read the [Content Policy](https://github.com/ipfs/awesome-ipfs/blob/main/CONTRIBUTING.md#content-policy) ⭐ 4,603 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13, and [**submit a PR**](https://github.com/ipfs/awesome-ipfs/edit/main/README.md) ⭐ 4,603 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13
...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,559 | 🐛 110 | 🌐 JavaScript | 📅 2026-08-13 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,447 | 🐛 101 | 🌐 Java | 📅 2026-08-21 - End-to-end encrypted, peer-to-peer file storage and sharing.
* [Planet](https://github.com/Planetable/Planet) ⭐ 1,811 | 🐛 80 | 🌐 Swift | 📅 2026-07-11 - Build and host decentralized blogs and websites with IPFS on your Mac
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,548 | 🐛 114 | 🌐 TypeScript | 📅 2026-08-21 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 874 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-21 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
...
* [hyprspace](https://github.com/hyprspace/hyprspace) ⭐ 244 | 🐛 32 | 🌐 Go | 📅 2026-07-14 - A Lightweight VPN Built on top of IPFS + Libp2p for Truly Distributed Networks.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,796 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
* [ipfs-companion](https://github.com/ipfs/ipfs-companion) ⭐ 2,157 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-06 - Browser extension that simplifies access to IPFS resources.
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,096 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 - Checks which public gateways are online or not.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 944 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-20 - Decentralized Solidity contract source code verification service
...
* [Omnipin](https://github.com/omnipin/omnipin) ⭐ 65 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-19 - The ultimate decentralized website deployment toolkit.
...
* [rivet](https://github.com/wabarc/rivet) ⭐ 12 | 🐛 7 | 🌐 Go | 📅 2023-07-31 - A toolkit makes it easier to archive webpages to IPFS.
...
* [IPFS-boot](https://github.com/rhodey/IPFS-boot) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-11 - Publish IPFS webapps which require user consent to update.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,096 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21
