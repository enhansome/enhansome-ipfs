...
To submit your project, read the [Content Policy](https://github.com/ipfs/awesome-ipfs/blob/main/CONTRIBUTING.md#content-policy) ⭐ 4,612 | 🐛 18 | 🌐 JavaScript | 📅 2025-11-13, and [**submit a PR**](https://github.com/ipfs/awesome-ipfs/edit/main/README.md) ⭐ 4,612 | 🐛 18 | 🌐 JavaScript | 📅 2025-11-13
...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,569 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-03 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,455 | 🐛 101 | 🌐 Java | 📅 2026-09-01 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,558 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-02 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-02 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
...
* [hyprspace](https://github.com/hyprspace/hyprspace) ⭐ 246 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - A Lightweight VPN Built on top of IPFS + Libp2p for Truly Distributed Networks.
...
* [go-orbit-db](https://github.com/berty/go-orbit-db) ⭐ 454 | 🐛 7 | 🌐 Go | 📅 2026-09-02 - This is a Golang port of OrbitDB that intends to be fully compatible with the original JavaScript version. OrbitDB is a serverless, distributed, peer-to-peer database.
...
* [ipfs-pinner](https://github.com/wabarc/ipfs-pinner) ⭐ 58 | 🐛 8 | 🌐 Go | 📅 2026-07-22 - A toolkit help upload files to IPFS pinning services.
