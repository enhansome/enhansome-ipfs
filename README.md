...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,570 | 🐛 114 | 🌐 JavaScript | 📅 2026-09-06 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,460 | 🐛 100 | 🌐 Java | 📅 2026-09-06 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,564 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-04 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-05 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,800 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 950 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-01 - Decentralized Solidity contract source code verification service
...
* [ipfs-pinner](https://github.com/wabarc/ipfs-pinner) ⭐ 58 | 🐛 7 | 🌐 Go | 📅 2026-09-05 - A toolkit help upload files to IPFS pinning services.
