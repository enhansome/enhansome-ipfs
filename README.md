...
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,526 | 🐛 96 | 🌐 Java | 📅 2026-09-24 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [hyprspace](https://github.com/hyprspace/hyprspace) ⭐ 248 | 🐛 34 | 🌐 Go | 📅 2026-08-26 - A Lightweight VPN Built on top of IPFS + Libp2p for Truly Distributed Networks.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,811 | 🐛 26 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
* [ipfs-companion](https://github.com/ipfs/ipfs-companion) ⭐ 2,162 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-16 - Browser extension that simplifies access to IPFS resources.
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,101 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-23 - Checks which public gateways are online or not.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 953 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-24 - Decentralized Solidity contract source code verification service
* [IPDR](https://github.com/miguelmota/ipdr) ⚠️ Archived - IPFS-backed Docker Registry.
* [go-orbit-db](https://github.com/berty/go-orbit-db) ⭐ 456 | 🐛 6 | 🌐 Go | 📅 2026-09-21 - This is a Golang port of OrbitDB that intends to be fully compatible with the original JavaScript version. OrbitDB is a serverless, distributed, peer-to-peer database.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,101 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-23
