...
To submit your project, read the [Content Policy](https://github.com/ipfs/awesome-ipfs/blob/main/CONTRIBUTING.md#content-policy) ⭐ 4,611 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13, and [**submit a PR**](https://github.com/ipfs/awesome-ipfs/edit/main/README.md) ⭐ 4,611 | 🐛 19 | 🌐 JavaScript | 📅 2025-11-13
...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,576 | 🐛 112 | 🌐 JavaScript | 📅 2026-09-07 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,460 | 🐛 102 | 🌐 Java | 📅 2026-09-06 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-07 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
...
* [hyprspace](https://github.com/hyprspace/hyprspace) ⭐ 246 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - A Lightweight VPN Built on top of IPFS + Libp2p for Truly Distributed Networks.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,801 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,099 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 - Checks which public gateways are online or not.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 950 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-07 - Decentralized Solidity contract source code verification service
* [IPDR](https://github.com/miguelmota/ipdr) ⚠️ Archived - IPFS-backed Docker Registry.
* [go-orbit-db](https://github.com/berty/go-orbit-db) ⭐ 454 | 🐛 6 | 🌐 Go | 📅 2026-09-04 - This is a Golang port of OrbitDB that intends to be fully compatible with the original JavaScript version. OrbitDB is a serverless, distributed, peer-to-peer database.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,099 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21
