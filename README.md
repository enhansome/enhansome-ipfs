...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,585 | 🐛 112 | 🌐 JavaScript | 📅 2026-09-17 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,518 | 🐛 102 | 🌐 Java | 📅 2026-09-17 - End-to-end encrypted, peer-to-peer file storage and sharing.
* [Planet](https://github.com/Planetable/Planet) ⭐ 1,812 | 🐛 80 | 🌐 Swift | 📅 2026-08-28 - Build and host decentralized blogs and websites with IPFS on your Mac
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,574 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-04 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
* [Agregore](https://github.com/AgregoreWeb/agregore-browser) ⭐ 921 | 🐛 103 | 🌐 JavaScript | 📅 2026-07-13 - A minimal web browser for the distributed web. Supports downloading/uploading data from IPFS using the browser's `fetch()` API
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,806 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
* [ipfs-companion](https://github.com/ipfs/ipfs-companion) ⭐ 2,160 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-16 - Browser extension that simplifies access to IPFS resources.
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,102 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-21 - Checks which public gateways are online or not.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 951 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-16 - Decentralized Solidity contract source code verification service
...
* [git-ipfs-rehost](https://github.com/whyrusleeping/git-ipfs-rehost) ⭐ 204 | 🐛 3 | 🌐 Shell | 📅 2020-11-05 - A script to rehost your git repos in ipfs.
...
* [Omnipin](https://github.com/omnipin/omnipin) ⭐ 66 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14 - The ultimate decentralized website deployment toolkit.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,102 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-21
