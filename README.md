...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,577 | 🐛 112 | 🌐 JavaScript | 📅 2026-09-07 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,486 | 🐛 101 | 🌐 Java | 📅 2026-09-09 - End-to-end encrypted, peer-to-peer file storage and sharing.
...
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,565 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-04 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-08 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,100 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 - Checks which public gateways are online or not.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 950 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-08 - Decentralized Solidity contract source code verification service
* [IPDR](https://github.com/miguelmota/ipdr) ⚠️ Archived - IPFS-backed Docker Registry.
* [go-orbit-db](https://github.com/berty/go-orbit-db) ⭐ 454 | 🐛 7 | 🌐 Go | 📅 2026-09-09 - This is a Golang port of OrbitDB that intends to be fully compatible with the original JavaScript version. OrbitDB is a serverless, distributed, peer-to-peer database.
...
* [ipfs-action](https://github.com/aquiladev/ipfs-action) ⭐ 180 | 🐛 11 | 🌐 JavaScript | 📅 2024-09-01 - GitHub Action for delivery of static websites.
...
* [Omnipin](https://github.com/omnipin/omnipin) ⭐ 65 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-22 - The ultimate decentralized website deployment toolkit.
...
* [Public Gateway Checker](https://github.com/ipfs/public-gateway-checker) ⭐ 2,100 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21
